...
namespace MediaFileRecorder
{
	...
	private:
        ...
        static unsigned int WINAPI VideoWriteFileThreadProc(void* Param);
        static unsigned int WINAPI AuidoWriteFileThreadProc(void* Param);
	...
	private:
		...
		HANDLE m_WriteVideoThread;
		HANDLE m_WriteAudioThread;
